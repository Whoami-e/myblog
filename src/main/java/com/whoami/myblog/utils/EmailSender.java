...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_QQ(false), "1695033362@qq.com", "kesylfntwuvreech");
    }
    ...
    public static void sendRegisterVerifyCode(String code, String emailAddress) throws Exception{
        EmailSender.subject("HALO博客系统验证邮件")
                .from("HALO博客系统")
                .text("【HALO博客系统】验证码：" + code + "，用于邮箱验证，5分钟内有效。验证码提供给他人可能导致账号被盗，请勿泄露，谨慎被骗。")
                .to(emailAddress)
                .send();
    }
